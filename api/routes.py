...
from core.scraper import scrape_status, run_scraping, clean_filename
...
def stop_scraping():
    """Yêu cầu dừng tiến trình thu thập đang chạy."""
    if scrape_status["running"]:
        scrape_status["stop_requested"] = True
        return {"message": "Đã gửi yêu cầu dừng thu thập"}
